...
Здесь собрана техническая документация приложения. При изменении публичного
поведения, контракта или структуры пакета соответствующую страницу нужно
обновлять в том же наборе коммитов.
