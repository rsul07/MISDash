...
несовместимых единицах измерения. Отсутствующий ряд или пустая группа
отображаются без ошибки; исходные наблюдения и поля МИС компоненту неизвестны.
...
3. Открыть все группы графиков.
4. Проверить, что tooltip содержит дату и значение.
