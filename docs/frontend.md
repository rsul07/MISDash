...
| --- | --- |
| Артериальное давление | `systolic`, `diastolic` |
| Гликемический контроль | `glucose`, `hba1c` |
| Почки | `creatinine`, `potassium` |
| Липиды | `total-cholesterol`, `ldl-cholesterol`, `hdl-cholesterol`, `triglycerides` |
...
- расчётная СКФ пока не входит в `DashboardResponse v1`;
