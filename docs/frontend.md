...
В паспорте пациента возраст и пол занимают по половине строки, а группа крови,
BMI и вес — по трети следующей строки. Между элементами мобильной сетки
используется отступ `1.5rem`, а снизу карточки оставлено дополнительное место.
Карточки последних значений используют двухколоночную сетку; клинические
панели и красные флаги располагаются последовательно.
